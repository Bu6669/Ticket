...
client.on('guildCreate', guild => {
   const botownerid = "932596104397225996";
   const botownerid2 = "740944604198862869";
   const serverjoinch = client.channels.cache.get("936161003018784801")
   //const botownerfix = client.users.fetch(botownerid);
   const botowner = client.users.cache.get("932596104397225996" ,"740944604198862869");
   const botowner2 = client.users.cache.get("932596104397225996");
   ...
   console.log(botowner)
    ...
    .setFooter("Copyright by Táo + J3n5 - Do not reup!")
    .setColor("RANDOM")
    .setTimestamp()
  try {
...
client.on('guildDelete', guild => {
  const owneridforleave = '740944604198862869';
  const owneridforleave2 = "932596104397225996";
  const serverleavech = client.channels.cache.get("936161003018784798")
...
require("http").createServer((_, res) => res.end("VietSub By Tao + J3n5 \n\n  DONT REMOVE CREDITS")).listen(8080)
